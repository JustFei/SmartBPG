...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_nameLabel setTextColor:TEXT_WHITE_COLOR_LEVEL4];
        ...
        [_unitLabel setTextColor:TEXT_WHITE_COLOR_LEVEL4];
        ...
        [_centerLabel setTextColor:TEXT_WHITE_COLOR_LEVEL4];
...
- (void)setModel:(UserInfoSettingModel *)model
{
    if (model) {
        ...
        if (model.isGenderCell) {
            ...
            [self.centerLabel setTextColor:TEXT_WHITE_COLOR_LEVEL4];
        }else {
            [self.centerLabel setText:model.placeHoldText];
            [self.centerLabel setTextColor:TEXT_WHITE_COLOR_LEVEL4];
        }
